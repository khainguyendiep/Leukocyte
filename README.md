# LEUKOCYTE
[Leukocyte](https://github.com/khainguyendiep/Leukocyte) is a toolset for detecting anomalies, helping SOC analysts customize their SIEM tools to detect more behavior from attackers.
## Toolset
1. [Anti-DoS](anti-DoS/)
## Acknowledgements
